...
func (s *appState) addModel(model khunquantconfig.ModelConfig) {
...
func refreshModelMenu(menu *Menu, currentModel string, models []khunquantconfig.ModelConfig) {
...
func (s *appState) testModel(model *khunquantconfig.ModelConfig) {
	if model == nil {
		return
	}
